...
import { EditiTask } from '../modals/EditiTask';
        ...
        <div className = "card-wrapper m-5">
            ...
            <div className = "task-holder">
                ...
                <div style={{"position": "absolute", "right" : "20px", "bottom" : "20px"}}>
                    <i className = "far fa-edit ml-3 one_i" style={{"color" : colors[index%5].primaryColor, "cursor" : "pointer"}} onClick = {() => setModal(true)}></i>
                    <i className="fas fa-trash-alt  mr-3 " style = {{"color" : colors[index%5].primaryColor, "cursor" : "pointer"}} onClick = {handleDelete}></i>
                </div>
        </div>
        <EditiTask modal={modal}
         toggle={toggle}
